  ...
  try {
    ...
    if (data.success && data.data) {
      ...
      if (count === 0) {
        ...
        headlineHtml = `
          <div style="background:linear-gradient(135deg,#1565c0,#1e88e5);color:#fff;border-radius:10px;padding:14px 16px;margin-bottom:12px;">
            <div style="font-size:15px;font-weight:700;margin-bottom:6px;">
              <i class="fas fa-exclamation-circle me-2" style="color:#FFD54F;"></i>${headline}
            </div>
